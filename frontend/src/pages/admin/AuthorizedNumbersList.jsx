...
export default function AuthorizedNumbersList() {
  ...
  const fetchNumbers = async () => {
    try {
      setLoading(true);
      const res = await fetch("https://api.movecash.online/api/numero_autorise", {
        headers: { 
  ...
  const fetchCountries = async () => {
    try {
      const res = await fetch("https://api.movecash.online/api/country", {
  ...
  const fetchAgents = async () => {
    try {
      const res = await fetch("https://api.movecash.online/api/agent", {
        headers: { Authorization: `Bearer ${token}` }
      });
      if (res.ok) {
        const data = await res.json();
  ...
  const fetchPaymentMethods = async () => {
    try {
      const res = await fetch("https://api.movecash.online/api/payment_method", {
        headers: { Authorization: `Bearer ${token}` }
      });
      if (res.ok) {
        const data = await res.json();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const url = form.id
        ? `https://api.movecash.online/api/numero_autorise/${form.id}`
        : "https://api.movecash.online/api/numero_autorise";
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`https://api.movecash.online/api/numero_autorise/${id}`, {
        method: "DELETE",
        headers: { 
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json"
